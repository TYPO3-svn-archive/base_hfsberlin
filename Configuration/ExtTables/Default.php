...
switch( true )
{
  ...
  default:
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile($_EXTKEY, 'Configuration/TypoScript/HfS/Org/Headquarters/501/',     'HfS Berlin: HfS [4] +Org Headquarters');
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile($_EXTKEY, 'Configuration/TypoScript/HfS/Org/Headquarters/511/',     'HfS Berlin: HfS [4] +Org Headquarters - marginal');
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile($_EXTKEY, 'Configuration/TypoScript/BAT/Caddy/',                    'HfS Berlin: BAT [2] +Caddy Base');
