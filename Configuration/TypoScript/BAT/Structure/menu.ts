...
base_hfsberlin {
  bat {
    ...
    menu.menuIcons {
      ...
      // 20 < base_hfsberlin.bat.menu.pdflink
      30 < base_hfsberlin.bat.menu.printlink
    }

    menu.menuIconsTop < base_hfsberlin.bat.menu.menuIcons
    menu.menuIconsTop {
      wrap = <ul id="nav_icons_top"> | </ul>

    }

    menu.menuIconsBottom < base_hfsberlin.bat.menu.menuIcons
