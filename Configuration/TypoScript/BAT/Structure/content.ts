  ...
  structure {
    ...
    content {
      ...
      footer {
        ...
        20 < base_batberlin.menu.menuIconsBottom
        20 {
      ...
      main {
        ...
        10 {
          ...
          10 = COA
          10 {
            10 < base_batberlin.menu.menuIconsTop
            20 = HMENU
            20 {
              special = directory
              special {
                value = {$base_batberlin.pages.libraries.quicknav}
              }
              maxItems  = 1
              begin     = 1
      ...
      margin {
        10 < styles.content.get
        10 {
          select.pidInList = {$base_batberlin.pages.margin}
          XXXstdWrap {
      ...
      navigation {
        ...
        10 {
          ...
          20 {
            special = list
            special.value = {$base_batberlin.pages.root}
            1 < base_batberlin.menu.tmenu
            1.IFSUB     >
            1.CURIFSUB  >
            1.ACTIFSUB  >
          ...
          22 < base_batberlin.menu.menuMain
          23 = TEXT
          23 {
            value = <p>&nbsp;</p>
          }
