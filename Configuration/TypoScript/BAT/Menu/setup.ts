...
base_batberlin {
  ...
  menu.menuMain {
    # Menue ab Ebene 1
    entry.level = 1
    1 < base_batberlin.menu.tmenu
    2 < base_batberlin.menu.tmenu
    3 < base_batberlin.menu.tmenu
    4 < base_batberlin.menu.tmenu
  }
    // menu.menuMain
  ...
  menu.menuIcons {
    ...
    // 20 < base_batberlin.menu.pdflink
    30 < base_batberlin.menu.printlink
  }

  menu.menuIconsTop < base_batberlin.menu.menuIcons
  menu.menuIconsTop {
    wrap = <ul id="nav_icons_top"> | </ul>

  }

  menu.menuIconsBottom < base_batberlin.menu.menuIcons
